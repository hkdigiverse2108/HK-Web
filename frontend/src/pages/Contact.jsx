          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 pb-6 border-b border-white/5">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 gap-2">
                {(() => {
                  const socialList = content?.site_settings?.footer?.social_links || content?.site_settings?.social_links || [];
                  return [
                    {
                      name: 'LinkedIn',
                      url: socialList.find(s => s.platform?.toLowerCase() === 'linkedin')?.url || 'https://linkedin.com',
                    ...
                    {
                      name: 'Instagram',
                      url: socialList.find(s => s.platform?.toLowerCase() === 'instagram')?.url || 'https://instagram.com',
                    ...
                    {
                      name: 'Twitter / X',
                      url: socialList.find(s => {
                        const p = s.platform?.toLowerCase() || '';
                        return p === 'twitter' || p === 'twitter / x' || p === 'x';
                    ...
                    {
                      name: 'YouTube',
                      url: socialList.find(s => s.platform?.toLowerCase() === 'youtube')?.url || 'https://youtube.com',
